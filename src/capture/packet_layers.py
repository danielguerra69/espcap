...
def get_layers(packet):
    ...
    for i in range(1,n):
        ...
        # Transport layer - TCP, UDP, ICMP, IDMP, or ESP
        elif layer.layer_name == "tcp" or layer.layer_name == "udp" or layer.layer_name == "idmp" or layer.layer_name == "idmp" or layer.layer_name == "esp":
            layers[layer.layer_name] = get_layer_fields(layer)
